...
class SimpleTemplate(BaseTemplate):
    ...
    def code(self):
        ...
        code = parser.translate(self.env)
        # print(code)
...
class StplParser(object):
    ...
    def flush_text(self):
        ...
        for m in self.re_inl.finditer(text):
            ...
            if prefix.endswith('\n'): parts[-1] += nl
            # print('ASD: ', m.group(1))
            # print(m.group(1), m.group(1) in self.env)
            # my hack is here
            if m.group(1) in self.env:
                parts.append(self.process_inline(m.group(1).strip()))
            else:
                # print(m.group(1))
                # parts[-1] += parts[-1][0:-1] + m.group(1).strip()
                # print(parts)
                # my hack is here. this line was uncommented
